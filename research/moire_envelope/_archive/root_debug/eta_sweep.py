...
import sys, math, json, shutil, time, argparse
...
def collect_observables(work_dir, moire_params, source_cdir, config):
    ...
    # Load Phase 1 data for band frequencies
    bloch_fields, subspace_bands, all_bands = p4.load_phase1_bloch_fields(work_dir)
