#!/usr/bin/env python3
"""Corrected MPB TM solve at X point for 4° angle, 20 bands, 64 px/cell."""
import os, time
...
print(f'4deg X-point: res={mpb_resolution}, {n_bands} bands, {len(geometry)} rods')
print(f'k-point: {k_x}')
...
np.savez(os.path.join(DATA_DIR, 'mpb_tm_x_4deg_res64_20bands.npz'),
