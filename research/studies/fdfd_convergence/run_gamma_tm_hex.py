#!/usr/bin/env python3
"""
FDFD TM convergence study at the Gamma point for hex rods lattice.
...
# Same commensurate angles as M-point study
ANGLES = [
    {'m': 9,  'n': 7,  'label': '8deg'},
    {'m': 9,  'n': 8,  'label': '4deg'},
...
# Resolution schedule matching final M-point compact plot
ANGLE_RESOLUTIONS = {
    '8deg': [1, 4, 8, 16],
    '4deg': [1, 4, 8, 16],
    '2deg': [1, 4, 8, 16],
...
def main():
    ...
    ok, fail = 0, 0
    t_start = time.time()
    print(f'Gamma-point hex FDFD TM convergence — {total} runs')
