...
pub fn identify_bravais_3d(metric: &Matrix3<f64>, tol: f64) -> Bravais3D {
    ...
    match (all_equal, a_eq_b, b_eq_c, a_eq_c, all_90, gamma_120) {
        ...
        (false, true, false, false, _, true) if alpha_90 && beta_90 => Bravais3D::Hexagonal(centering),
        ...
        (false, false, false, false, false, _) if alpha_90 && gamma_90 && !beta_90 => Bravais3D::Monoclinic(centering),
