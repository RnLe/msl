...
pub fn generate_2d_high_symmetry_points(bravais: &Bravais2D) -> HighSymmetryData {
    ...
    match bravais {
        ...
        Bravais2D::Oblique => {
            ...
            data.set_standard_path(HighSymmetryPath::new(vec![SymmetryPointLabel::Gamma]));
        }
    }
    ...
    match bravais {
        Cubic(_) => {
            ...
            data.add_alternative_path(
                "Extended",
                HighSymmetryPath::new(vec![SymmetryPointLabel::M, SymmetryPointLabel::R]),
            );
        }
