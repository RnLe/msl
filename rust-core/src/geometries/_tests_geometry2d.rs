...
mod _tests_geometry2d {
    ...
    fn test_circle_contains_point() {
        ...
        // Test points inside
        assert!(
            circle.contains_point(Vector2::new(0.0, 0.0)),
            "Center should be inside"
        );
        assert!(
            circle.contains_point(Vector2::new(3.0, 4.0)),
            "Point (3,4) should be inside (distance=5)"
        );
        assert!(
            circle.contains_point(Vector2::new(5.0, 0.0)),
            "Point on boundary should be inside"
        );

        // Test points outside
        assert!(
            !circle.contains_point(Vector2::new(5.1, 0.0)),
            "Point just outside should not be inside"
        );
        assert!(
            !circle.contains_point(Vector2::new(4.0, 4.0)),
            "Point (4,4) should be outside (distance≈5.66)"
        );
    }
    ...
    fn test_circle_transform() {
        ...
        assert!(
            approx_eq(circle.radius, 6.0, 1e-10),
    ...
    fn test_rectangle_contains_point() {
        ...
        // Test points inside
        assert!(
            rect.contains_point(Vector2::new(0.0, 0.0)),
            "Center should be inside"
        );
        assert!(
            rect.contains_point(Vector2::new(5.0, 3.0)),
        ...
        // Test points outside
        assert!(
            !rect.contains_point(Vector2::new(5.1, 0.0)),
            "Point just outside should not be inside"
        );
        assert!(
            !rect.contains_point(Vector2::new(0.0, 3.1)),
            "Point just outside should not be inside"
        );
    }
    ...
    fn test_rectangle_rotated_contains_point() {
        ...
        assert!(
            rect.contains_point(Vector2::new(0.0, 0.0)),
            "Center should still be inside after rotation"
        );
        ...
        assert!(
            ...
            "Point within rotated bounds should be inside"
        );

        // Test a point that should be outside
        let outside_point = Vector2::new(0.0, 10.0); // Definitely outside
        assert!(
            !rect.contains_point(outside_point),
            "Point outside rotated bounds should not be inside"
        );
    }
    ...
    fn test_rectangle_bounding_box() {
        ...
        assert!(
            approx_eq(rotated_bbox.min.x, -expected_extent, 1e-10),
            "Rotated bbox min.x incorrect: {} != {}",
            rotated_bbox.min.x,
            -expected_extent
        );
        assert!(
            approx_eq(rotated_bbox.max.x, expected_extent, 1e-10),
            "Rotated bbox max.x incorrect: {} != {}",
            rotated_bbox.max.x,
            expected_extent
        );
    }
    ...
    fn test_ellipse_contains_point() {
        ...
        // Test points inside
        assert!(
            ellipse.contains_point(Vector2::new(0.0, 0.0)),
            "Center should be inside"
        );
        assert!(
            ellipse.contains_point(Vector2::new(4.0, 0.0)),
            "Point on major axis should be inside"
        );
        assert!(
            ellipse.contains_point(Vector2::new(0.0, 2.0)),
            "Point on minor axis should be inside"
        );
        assert!(
            ellipse.contains_point(Vector2::new(2.0, 1.0)),
            "Point inside ellipse"
        );

        // Test points outside
        assert!(
            !ellipse.contains_point(Vector2::new(4.1, 0.0)),
            "Point just outside major axis"
        );
        assert!(
            !ellipse.contains_point(Vector2::new(3.0, 2.0)),
            "Corner point should be outside"
        );
    }
    ...
    fn test_ellipse_rotated_contains_point() {
        ...
        assert!(
            ellipse.contains_point(Vector2::new(0.0, 4.0)),
            "Point on rotated major axis"
        );
        assert!(
            ellipse.contains_point(Vector2::new(2.0, 0.0)),
            "Point on rotated minor axis"
        );
        assert!(
            !ellipse.contains_point(Vector2::new(4.0, 0.0)),
            "Previous major axis point should be outside"
        );
    }
    ...
    fn test_polygon_triangle_contains_point() {
        ...
        // Test points inside
        assert!(
            triangle.contains_point(Vector2::new(2.0, 1.0)),
            "Point inside triangle"
        );
        assert!(
            triangle.contains_point(Vector2::new(1.0, 0.5)),
            "Point near base"
        );

        // Test points outside
        assert!(
            !triangle.contains_point(Vector2::new(0.0, 3.0)),
            "Point outside left"
        );
        assert!(
            !triangle.contains_point(Vector2::new(4.0, 3.0)),
            "Point outside right"
        );
        assert!(
            !triangle.contains_point(Vector2::new(2.0, 4.0)),
            "Point above apex"
        );
    }
    ...
    fn test_polygon_regular() {
        ...
        assert!(
            hexagon.contains_point(Vector2::new(0.0, 0.0)),
            "Center should be inside"
        );
        assert!(
            hexagon.contains_point(Vector2::new(4.0, 0.0)),
            "Point near edge should be inside"
        );
        assert!(
            !hexagon.contains_point(Vector2::new(5.1, 0.0)),
    ...
    fn test_polygon_empty() {
        ...
        assert!(
            !empty_polygon.contains_point(Vector2::new(0.0, 0.0)),
    ...
    fn test_compound_geometry() {
        ...
        // Test contains_point
        assert!(
            compound.contains_point(Vector2::new(-5.0, 0.0)),
            "Circle center should be inside"
        );
        assert!(
            compound.contains_point(Vector2::new(5.0, 0.0)),
            "Rectangle center should be inside"
        );
        assert!(
            !compound.contains_point(Vector2::new(0.0, 0.0)),
            "Gap between shapes should be outside"
        );
    ...
    fn test_compound_geometry_transform() {
        ...
        assert!(
            compound.contains_point(Vector2::new(2.0, 3.0)),
            "Transformed center should contain point"
        );
    ...
    fn test_geometric_object_2d() {
        ...
        // Test shape access
        assert!(
            obj.shape().contains_point(Vector2::new(0.0, 0.0)),
            "Should access shape methods"
        );
        ...
        assert!(
            obj.shape().contains_point(Vector2::new(1.0, 1.0)),
            "Transform should affect shape"
        );
    }
    ...
    fn test_clone_box() {
        ...
        assert!(
            cloned_circle.contains_point(Vector2::new(1.0, 2.0)),
            "Cloned circle should have same properties"
        );

        let rect = Rectangle::new(Vector2::new(0.0, 0.0), Vector2::new(4.0, 4.0));
        let cloned_rect = rect.clone_box();
        assert!(
            cloned_rect.contains_point(Vector2::new(0.0, 0.0)),
            "Cloned rectangle should have same properties"
        );

        let ellipse = Ellipse::new(Vector2::new(0.0, 0.0), Vector2::new(2.0, 1.0));
        let cloned_ellipse = ellipse.clone_box();
        assert!(
            cloned_ellipse.contains_point(Vector2::new(0.0, 0.0)),
            "Cloned ellipse should have same properties"
        );

        let polygon = Polygon::regular(Vector2::new(0.0, 0.0), 2.0, 4);
        let cloned_polygon = polygon.clone_box();
        assert!(
            cloned_polygon.contains_point(Vector2::new(0.0, 0.0)),
            "Cloned polygon should have same properties"
        );
    }
    ...
    fn test_edge_cases_transform_scale() {
        ...
        assert!(
            approx_eq(circle.radius, 6.0, 1e-10),
            "Circle radius should use max scale factor"
        );
        ...
        assert!(
            rect.contains_point(Vector2::new(0.0, 0.0)),
            "Zero-scaled rectangle should still contain its center"
        );
    }
}
